...
addrrec addressmode[17]  = { {TEXT("")         ,1},        // (implied)
                             {TEXT("")         ,1},        // INVALID1
                             {TEXT("")         ,2},        // INVALID2
                             {TEXT("")         ,3},        // INVALID3
                             {TEXT("#$%02X")   ,2},        // ADDR_IMM
...
cmdrec command[COMMANDS] = { {TEXT("BA")      ,CmdBreakpointAdd},
...
instrec instruction[256] = { {TEXT("BRK"),0},              // 00h
...
COLORREF color[2][COLORS] = {{0x800000,0xC0C0C0,0x00FFFF,0x808000,
